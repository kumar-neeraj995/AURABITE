...
const seedData = async () => {
  try {
    // We assume mongoose is already connected via server.js
    ...
    const menuItems = [
      ...
      },
      {
        ...
        description: 'Penne pasta tossed in a rich, homemade basil pesto cream sauce, topped with roasted pine nuts and parmesan.',
        price: 490.00,
        category: 'Mains',
        imageUrl: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=600&auto=format&fit=crop&q=60'
      },
      {
        restaurantId: seededRestaurants[0]._id,
        name: 'Classic Caesar Salad',
        description: 'Crisp romaine lettuce, homemade garlic croutons, shaved parmesan, and creamy Caesar dressing.',
        price: 260.00,
        category: 'Appetizers',
      ...
      },
      {
        ...
        description: 'Thick cut sweet onions, breaded and fried to golden perfection, served with our signature zesty dipping sauce.',
        price: 140.00,
        category: 'Appetizers',
        imageUrl: 'https://images.unsplash.com/photo-1639024471283-03518883512d?w=600&auto=format&fit=crop&q=60'
      },
      {
        restaurantId: seededRestaurants[5]._id,
        name: 'Cheesy Garlic Bread',
        description: 'Oven-baked baguette slices smothered in garlic herb butter and melted mozzarella cheese.',
        price: 150.00,
        category: 'Appetizers',
