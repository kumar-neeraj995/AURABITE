...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchRestaurants = async () => {
      try {
        const res = await axios.get(`${'https://ckksi-14-139-228-10.run.pinggy-free.link'}/api/restaurants`);
        if (res.data.success) {
              ...
              >
                ...
                <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                  <div style={{
                    ...
                    <span style={{ fontSize: '0.7rem', color: 'var(--accent-coral)', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 'bold' }}>
                      An AuraBite Franchise
                    </span>
                    <div style={{
                      display: 'flex',
