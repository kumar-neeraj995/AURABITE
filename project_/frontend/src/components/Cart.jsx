...
const Cart = ({ isOpen, onClose }) => {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${import.meta.env.PROD ? '' : (import.meta.env.VITE_API_URL || 'http://localhost:5000')}/api/orders`, {
                    ...
                    {paymentMethod === 'PhonePe' && (
                      <div style={{ 
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '1rem' }}>
                          Scan the QR Code using <strong>PhonePe</strong>
                        </p>
                        ...
                        <div style={{
                          ...
                          <img 
                            src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=upi://pay?pa=7070878442@ybl&pn=NEERAJ%20KUMAR&cu=INR" 
                            alt="PhonePe QR Code"
                        ...
                        <p style={{ color: 'var(--accent-gold)', fontSize: '1rem', fontWeight: 'bold', letterSpacing: '1px' }}>
                          7070878442@ybl
                        </p>
